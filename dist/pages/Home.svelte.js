  ...
  <div class="sm:w-2/3"><h2 class="mt-0 svelte-1uoq69v" style="margin-top: 0">About</h2> 
    ...
    <div><p class="mt-4">My research is focused on developing novel statistical approaches to
      ...
      <p class="mt-4">Aside from independent research, I also enjoy multidisciplinary
        ...
        interpret results and co-author manuscripts.</p> 
      <p class="mt-4">See my CV (link to be added) and/or
        <a class="external-link" target="_blank" href="https://scholar.google.com/citations?user=35QeShYAAAAJ&amp;hl=en&amp;oi=ao">google
          scholar page</a>
    ...
    <div><p>Aastha Khatiwada</p> 
      ...
      <p>email: khatiwad at musc dot edu</p></div></div>`;
