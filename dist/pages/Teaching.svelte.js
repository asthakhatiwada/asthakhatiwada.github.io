...
function create_fragment(ctx) {
  ...
  <div class="pl-2 md:pl-6"><div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Level</p> 
      <p class="">Graduate</p></div> 
    <div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Topics covered</p> 
    ...
    <div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Student group</p> 
      <p class="">MS/PhD Biostatistics students.</p></div> 
    <div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Responsibilities</p> 
  ...
  <div class="pl-6"><div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Level</p> 
      <p class="">Graduate</p></div> 
    <div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Topics covered</p> 
  ...
  <div class="pl-6"><div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Class</p> 
  ...
  <div class="pl-6"><div class="flex card-row"><p class="card-row-header svelte-1kwnt2e">Responsibilities</p> 
